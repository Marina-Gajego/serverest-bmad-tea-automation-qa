...
Feature: Validate PUT user by ID API in different scenarios
  ...
  Scenario: Update existing user by ID - (PUT /usuarios/{_id})
    ...
    And The response contract should match "schemas/CreateUser/put_user_success.schema.json"
  ...
  Scenario: Update just nome field of the existing user by ID - (PUT /usuarios/{_id})
    ...
    And The response contract should match "schemas/CreateUser/put_user_bad_request_fields.schema.json"
  ...
  Scenario: Update user with non-existent ID - (PUT /usuarios/{_id})
    ...
    And The response contract should match "schemas/CreateUser/put_user_created.schema.json"
  ...
  Scenario: Attempt without id in the path - (PUT /usuarios)
    ...
    And The response contract should match "schemas/CreateUser/put_user_without_id.schema.json"
  ...
  Scenario: Attempt to update a user using an already registered email - (PUT /usuarios/{_id})
    ...
    And The response contract should match "schemas/CreateUser/put_user_bad_request_message.schema.json"
